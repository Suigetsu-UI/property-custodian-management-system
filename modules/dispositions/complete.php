...
try {
    getPropertyCoreServiceClient()->transitionDisposition($dispositionId, 'complete', dispositionCompletionGatewayPayload($_POST), currentPropertyCoreActor());
    header('Location: review.php?asset_id=' . rawurlencode($assetId) . '&message=sold');
