...
try {
    getPropertyCoreServiceClient()->transitionDisposition($dispositionId, 'reject', dispositionDecisionGatewayPayload($_POST), currentPropertyCoreActor());
    header('Location: review.php?asset_id=' . rawurlencode($assetId) . '&message=rejected');
