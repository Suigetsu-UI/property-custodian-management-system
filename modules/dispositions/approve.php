...
try {
    getPropertyCoreServiceClient()->transitionDisposition($dispositionId, 'approve', dispositionApprovalGatewayPayload($_POST), currentPropertyCoreActor());
    header('Location: review.php?asset_id=' . rawurlencode($assetId) . '&message=approved');
